...
import 'unit_price_model.dart';
export 'unit_price_model.dart';
...
class _UnitPriceWidgetState extends State<UnitPriceWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => UnitPriceModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final unitPricePurcheseResponse = snapshot.data!;
                              ...
                              children: [
                                Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      getJsonField(
                                        unitPricePurcheseResponse.jsonBody,
                                        r'''$.values[0][0]''',
                                      ).toString(),
                                      style: FlutterFlowTheme.of(context)
                                          .bodyMedium
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final item = PurcheseCall.values(
                                                    unitPricePurcheseResponse
                                                        .jsonBody,
                                                  )?.toList() ??
                                                  [];
