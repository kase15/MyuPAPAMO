...
import 'closed_day_model.dart';
export 'closed_day_model.dart';

class ClosedDayWidget extends StatefulWidget {
  const ClosedDayWidget({super.key});

  @override
  State<ClosedDayWidget> createState() => _ClosedDayWidgetState();
}

class _ClosedDayWidgetState extends State<ClosedDayWidget> {
  late ClosedDayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ClosedDayModel());
