...
import 'fixed_cost_model.dart';
export 'fixed_cost_model.dart';

class FixedCostWidget extends StatefulWidget {
  const FixedCostWidget({super.key});

  @override
  State<FixedCostWidget> createState() => _FixedCostWidgetState();
}

class _FixedCostWidgetState extends State<FixedCostWidget> {
  late FixedCostModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => FixedCostModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final fixedCostBudgetResponse = snapshot.data!;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final item = BudgetCall.values(
                                                    fixedCostBudgetResponse
                                                        .jsonBody,
                                                  )?.toList() ??
                                                  [];
