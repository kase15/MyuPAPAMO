...
import 'conect_model.dart';
export 'conect_model.dart';

class ConectWidget extends StatefulWidget {
  const ConectWidget({super.key});

  @override
  State<ConectWidget> createState() => _ConectWidgetState();
}

class _ConectWidgetState extends State<ConectWidget> {
  late ConectModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConectModel());
