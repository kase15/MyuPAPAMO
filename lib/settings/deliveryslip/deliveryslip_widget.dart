...
import 'deliveryslip_model.dart';
export 'deliveryslip_model.dart';

class DeliveryslipWidget extends StatefulWidget {
  const DeliveryslipWidget({super.key});

  @override
  State<DeliveryslipWidget> createState() => _DeliveryslipWidgetState();
}

class _DeliveryslipWidgetState extends State<DeliveryslipWidget> {
  late DeliveryslipModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DeliveryslipModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final deliveryslipNouhinResponse = snapshot.data!;
                                                              ...
                                                              style: FlutterFlowTheme
                                                                  ...
                                                                  .override(
                                                                    ...
                                                                    color: valueOrDefault<
                                                                      ...
                                                                      '完了' ==
                                                                              getJsonField(
                                                                                deliveryslipNouhinResponse.jsonBody,
                                                                                r'''$[15]''',
                                                                              )
                                                                                  .toString()
                                                                          ? FlutterFlowTheme.of(context)
