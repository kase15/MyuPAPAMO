...
import 'weekofthe_day_model.dart';
export 'weekofthe_day_model.dart';

class WeekoftheDayWidget extends StatefulWidget {
  const WeekoftheDayWidget({super.key});

  @override
  State<WeekoftheDayWidget> createState() => _WeekoftheDayWidgetState();
}

class _WeekoftheDayWidgetState extends State<WeekoftheDayWidget> {
  late WeekoftheDayModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WeekoftheDayModel());
                      ...
                      child: Container(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Align(
                              alignment: const AlignmentDirectional(-0.77, 0.07),
                              child: Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    20.0, 20.0, 0.0, 0.0),
                                child: SizedBox(
