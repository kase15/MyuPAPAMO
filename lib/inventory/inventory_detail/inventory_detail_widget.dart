...
export 'inventory_detail_model.dart';

class InventoryDetailWidget extends StatefulWidget {
  const InventoryDetailWidget({
    super.key,
    required this.date,
  });
  ...
  @override
  State<InventoryDetailWidget> createState() => _InventoryDetailWidgetState();
}

class _InventoryDetailWidgetState extends State<InventoryDetailWidget> {
  late InventoryDetailModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => InventoryDetailModel());
  ...
  Widget build(BuildContext context) {
    return FutureBuilder<ApiCallResponse>(
      ...
      builder: (context, snapshot) {
        ...
        final inventoryDetailInventoryResponse = snapshot.data!;
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        Container(
                                          ...
                                          child: Builder(
                                            builder: (context) {
                                              final item = InventoryCall.values(
                                                    inventoryDetailInventoryResponse
                                                        .jsonBody,
                                                  )?.toList() ??
                                                  [];
