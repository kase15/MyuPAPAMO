...
import 'b_udget_settings0_model.dart';
export 'b_udget_settings0_model.dart';

class BUdgetSettings0Widget extends StatefulWidget {
  const BUdgetSettings0Widget({
    super.key,
    required this.date,
  });
  ...
  @override
  State<BUdgetSettings0Widget> createState() => _BUdgetSettings0WidgetState();
}

class _BUdgetSettings0WidgetState extends State<BUdgetSettings0Widget> {
  late BUdgetSettings0Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BUdgetSettings0Model());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController1?.text = '500000';
          _model.textController2?.text = '5';
        }));
  }
