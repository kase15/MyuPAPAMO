...
import 'b_udget_settings2_model.dart';
export 'b_udget_settings2_model.dart';

class BUdgetSettings2Widget extends StatefulWidget {
  const BUdgetSettings2Widget({
    super.key,
  ...
  @override
  State<BUdgetSettings2Widget> createState() => _BUdgetSettings2WidgetState();
}

class _BUdgetSettings2WidgetState extends State<BUdgetSettings2Widget> {
  late BUdgetSettings2Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BUdgetSettings2Model());
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController1?.text = '40';
          _model.textController2?.text = '20';
        }));
  }
