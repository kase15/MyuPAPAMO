...
import 'b_udget_settings1_model.dart';
export 'b_udget_settings1_model.dart';

class BUdgetSettings1Widget extends StatefulWidget {
  const BUdgetSettings1Widget({
    super.key,
    required this.fixed,
  ...
  @override
  State<BUdgetSettings1Widget> createState() => _BUdgetSettings1WidgetState();
}

class _BUdgetSettings1WidgetState extends State<BUdgetSettings1Widget> {
  late BUdgetSettings1Model _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BUdgetSettings1Model());

    _model.textController ??= TextEditingController();
    _model.textFieldFocusNode ??= FocusNode();

    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController?.text = '100000';
        }));
  }
