...
import 'b_udget_settings_a_fter_model.dart';
export 'b_udget_settings_a_fter_model.dart';

class BUdgetSettingsAFterWidget extends StatefulWidget {
  const BUdgetSettingsAFterWidget({
    super.key,
    required this.date,
    required this.gain,
    required this.shiirehi,
    required this.pajinkenhi,
    required this.kyakutanka,
    required this.fixedcost,
    required this.changingvariable,
  });

  final DateTime? date;
  final double? gain;
  final double? shiirehi;
  final double? pajinkenhi;
  final double? kyakutanka;
  final double? fixedcost;
  final double? changingvariable;

  @override
  State<BUdgetSettingsAFterWidget> createState() =>
      _BUdgetSettingsAFterWidgetState();
}

class _BUdgetSettingsAFterWidgetState extends State<BUdgetSettingsAFterWidget> {
  late BUdgetSettingsAFterModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => BUdgetSettingsAFterModel());
